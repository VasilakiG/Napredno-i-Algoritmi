...
public class ListaOdListi {
    ...
    public static long findMagicNumber(DLL<DLL<Integer>> list) {
        ...
        DLLNode<DLL<Integer>> listNode = list.getFirst();
        DLLNode<Integer> elementNode = list.getFirst().element.getFirst();

        while(listNode != null){
            while(elementNode != null){
                sum += elementNode.element;
                elementNode = elementNode.succ;
            }
            product *= sum;
            sum = 0;
            listNode = listNode.succ;
            if(listNode != null){
                elementNode = listNode.element.getFirst();
            }
        }
